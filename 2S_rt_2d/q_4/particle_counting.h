...
void initial_setting(
    ...
    std::vector<unsigned int>& R1A, std::vector<unsigned int>& R2A, std::vector<unsigned int>& R3A, std::vector<unsigned int>& R4A, std::vector<unsigned int>& TA, 
    std::vector<unsigned int>& R1B, std::vector<unsigned int>& R2B, std::vector<unsigned int>& R3B, std::vector<unsigned int>& R4B, std::vector<unsigned int>& TB, 
    Ran& myran 
) 
{
