...
f_mAx = ax2.imshow(mA_x[0, :, :], cmap = 'bwr', origin = 'lower', aspect = 'equal', interpolation = 'nearest', vmin = -M_max, vmax = M_max) 
fig.colorbar(f_mAx, ax = ax2, fraction = 0.046, pad = 0.04) 
f_mAy = ax3.imshow(mA_y[0, :, :], cmap = 'bwr', origin = 'lower', aspect = 'equal', interpolation = 'nearest', vmin = -M_max, vmax = M_max) 
...
# ax7.set_xlabel("x") 
f_mBx = ax6.imshow(mB_x[0, :, :], cmap = 'bwr', origin = 'lower', aspect = 'equal', interpolation = 'nearest', vmin = -M_max, vmax = M_max) 
fig.colorbar(f_mBx, ax = ax6, fraction = 0.046, pad = 0.04) 
f_mBy = ax7.imshow(mB_y[0, :, :], cmap = 'bwr', origin = 'lower', aspect = 'equal', interpolation = 'nearest', vmin = -M_max, vmax = M_max) 
