...
subdir = "rhoA0_rhoB0" 
file_name = "sim_t49999_rho050_rhoA044.4_Dt0.1000_alphaA00.0100_sigmaA0.1111_kappa1.0000_etaAA-0.0000_etaAB3.0000_etaBA3.0000_etaBB-0.0000_Lx16384_Ly8_N11639193_n50000_20260118_143103.h5" 
...
plt.ion() 
x = np.arange(Lx) 
fig, (ax1, ax2, ax3, ax4, ax5, ax6, ax7) = plt.subplots(7, 1, sharex = True, figsize = (12, 8)) 
plt.subplots_adjust(hspace = 0.1) 

f_rhoA = ax1.imshow(rhoA[0, :, :].T, cmap = 'viridis', origin = 'lower', extent = [0, Lx-1, 0, Ly-1], aspect = 'auto', interpolation = 'nearest') 
...
f_rhoB = ax3.imshow(rhoB[0, :, :].T, cmap = 'viridis', origin = 'lower', extent = [0, Lx-1, 0, Ly-1], aspect = 'auto', interpolation = 'nearest') 
fig.colorbar(f_rhoB, ax = ax3, fraction = 0.046, pad = 0.04) 
